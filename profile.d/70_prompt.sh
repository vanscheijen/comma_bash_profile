...
export PS1="\[\e]0;\h (pts/\l #\#) \w\a\]\[${RESET}${WHITE}\]\t\[${XITALIC}${DIMGRAY}\](\[${XDIM}\]j\[${BLUE}\]\j\[${DIMGRAY}\] x\$(EV=\$?; [[ \$EV == 0 ]] && printf \[${YELLOW}\]0 || printf \[${RED}\]\$EV;[[ \$SHLVL -gt 1 ]] && printf \[${DIMGRAY}\]\ s\[${CYAN}\]\$SHLVL;,,git_ps1_info \[ \])\[${RESET}${DIMGRAY}\])\[${XDIM}${USER_COLOR}\]\u\[${RESET}${DIMGRAY}\]@\[${GRAY}\]\h\[\$([[ -w \$PWD ]] && printf $GREEN || printf $RED)\]:\[${WHITE}\]\w\[${GRAY}\]>\[${RESET}${CURSOR_SHOW}\] "
